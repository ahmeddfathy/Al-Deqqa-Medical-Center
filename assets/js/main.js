...
==================================*/
  ...
  if ($(".service-circle__item").length) {
    ...
    $(".service-circle__menu li a").each(function (index) {
      ...
      tabLink.on("click", function (e) {
        ...
        $(`.service-circle__item[data-tab-no="${Tabcurrent}"]`)
          .addClass("active")
          .siblings()
          .removeClass("active");
      });
  ...
  if ($(".vs-carousel").length) {
    $(".vs-carousel").each(function () {
      var vsCarousel = $(this);
      var slideNum = vsCarousel.data("slide-show") || 1;
      ...
      vsCarousel.slick({
        ...
        slidesToScroll: 1,
        arrows: false, // مهم: يجب أن تكون false لتعمل الأزرار المخصصة
        rtl: true, // للدعم العربي
        responsive: [
          {
            breakpoint: 1199,
            settings: {
              slidesToShow: slideNum > 3 ? 3 : slideNum,
            },
          },
          {
            breakpoint: 992,
            settings: {
              slidesToShow: slideNum > 2 ? 2 : slideNum,
            },
          },
          {
            breakpoint: 767,
